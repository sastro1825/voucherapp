                ...
                @foreach ($vouchers as $voucher)
                    <tr class="border-b dark:border-gray-600">
                        ...
                        <td class="p-2">
                            ...
                            @else
                                <button type="button" 
                                        class="open-whatsapp-modal inline-flex items-center w-24 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg shadow-sm hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150"
